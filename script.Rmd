...
# gganimate code to transition states by date:
        ...
        labs(title='2018-2019 Premier League Standings') #need to reinsert date into the visualization to see when state changes are happening.


#all that remains is smoothing out the animation
